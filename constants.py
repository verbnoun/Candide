...
MOD_LFO_DEBUG = False
MOD_ENV_DEBUG = False
MPE_ROUTE_DEBUG = True
MPE_NOTE_DEBUG = True
MPE_VOICE_DEBUG = True
MPE_ROUTER_DEBUG = True
MPE_MESSAGE_FILTER_DEBUG = True  # Master switch for message filtering logs
MPE_FILTER_ACCEPT_LOG = True     # Log accepted messages
MPE_FILTER_REJECT_LOG = True     # Log rejected messages
